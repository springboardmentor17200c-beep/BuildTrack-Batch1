...
export const DASHBOARD_ROUTES: Routes = [
  {
    ...
    canActivate: [roleGuard('dashboard-admin')],
  },
  {
    path: 'pm',
    component: PmDashboardComponent,
    canActivate: [roleGuard('dashboard-pm')],
  },
  {
    path: 'site-engineer',
    component: SiteEngineerDashboardComponent,
    canActivate: [roleGuard('dashboard-site-engineer')],
  },
  {
    path: 'contractor',
    component: ContractorDashboardComponent,
    canActivate: [roleGuard('dashboard-contractor')],
  },
  {
    path: 'client',
    component: ClientDashboardComponent,
    canActivate: [roleGuard('dashboard-client')],
  },
];
