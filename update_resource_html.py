...
html_path = 'C:/Users/pradu/BuildTrack-Batch1/frontend/buildtrack-frontend/src/app/features/analytics/resource-analytics/resource-analytics.component.html'
    ...
    <div class="bt-table-wrap" style="display: flex; gap: 24px;">
      ...
      <div style="flex: 1;">
        <table class="bt-table">
          <thead><tr><th>Category</th><th>Total Assets</th><th>In Use</th><th>Avg Utilization</th></tr></thead>
          <tbody>
            <tr *ngFor="let c of categorySummaries">
              ...
              <td>
                <div class="bt-progress">
                  <div class="bt-progress-bar"><div class="bt-progress-fill purple" [style.width.%]="c.avgUtilization"></div></div>
                  <span class="bt-progress-value">{{ c.avgUtilization }}%</span>
                </div>
              </td>
            </tr>
          </tbody>
