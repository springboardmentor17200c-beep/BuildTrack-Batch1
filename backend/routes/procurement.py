...
db_vendors: Dict[str, dict] = {}
db_requests: Dict[str, dict] = {}
db_purchase_orders: Dict[str, dict] = {}
db_deliveries: Dict[str, dict] = {}
db_inventory: Dict[str, dict] = {}
db_invoices: Dict[str, dict] = {}
...
def reject_request(request_id: str, comments: str = None):
    if request_id not in db_requests:
        raise HTTPException(status_code=404, detail="Request not found")
...
def select_vendor_for_request(request_id: str, vendor_id: str):
    if request_id not in db_requests:
        raise HTTPException(status_code=404, detail="Request not found")
    req = db_requests[request_id]
